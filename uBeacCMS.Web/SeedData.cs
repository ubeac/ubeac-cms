...
public static class SeedData
{
    public static void SeedDefaultData(this IServiceProvider provider)
    {
        ...
        var skinService = scope.ServiceProvider.GetRequiredService<ISkinService>();
        ...
        if (!siteService.GetAll().GetAwaiter().GetResult().Any())
        {
            ...
            { 
                new Skin
                {
                    Id = Guid.NewGuid(),
                    Name = "Default Skin",
                    ContainerType = SkinContainerType.Site,
...
<body>
                ...
                <ul class=""menu-inner py-1"">
                    ...
                    <li class=""menu-item"">
                        ...
                        <ul class=""menu-sub"">
                            ...
                            <li class=""menu-item"">
                                <a href=""/servers/dell"" class=""menu-link"">
                                    <div data-i18n=""Dell"">Dell</div>
                                </a>
                            </li>
                            <li class=""menu-item"">
                                <a href=""/servers/hp"" class=""menu-link"">
    ...
    ",
            ...
            skinService.AddRange(skins).GetAwaiter();
            ...
            var site = new Site
            {
                ...
                SkinIds = skins.Select(x=> x.Id).ToList()
            };
